...
import 'schema/mis_users_record.dart';
import 'schema/id_record.dart';
...
export 'schema/mis_users_record.dart';
export 'schema/id_record.dart';
...
Future<FFFirestorePage<MisUsersRecord>> queryMisUsersRecordPage({
  Query Function(Query)? queryBuilder,
  DocumentSnapshot? nextPageMarker,
  required int pageSize,
  required bool isStream,
...
/// Functions to query IdRecords (as a Stream and as a Future).
Stream<List<IdRecord>> queryIdRecord({
  Query Function(Query)? queryBuilder,
  int limit = -1,
  bool singleRecord = false,
}) =>
...
Future<List<IdRecord>> queryIdRecordOnce({
  Query Function(Query)? queryBuilder,
  int limit = -1,
  bool singleRecord = false,
}) =>
...
Future<FFFirestorePage<IdRecord>> queryIdRecordPage({
  Query Function(Query)? queryBuilder,
  DocumentSnapshot? nextPageMarker,
  required int pageSize,
  required bool isStream,
